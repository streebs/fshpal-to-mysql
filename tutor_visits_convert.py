...
def main():
    ...
    index=['visit_id', 'date', 'timei', 'timeo', 'timev', 'uvid', 'name', 'center', 'class']
    ...
    with spinner.Spinner("converting data... "):
        # print(f"Number of Duplicates: {df.duplicated('visit_id').sum()}")
        ...
        # convert the timeo column to 24 hour format
